...
export type LegalContentType = 'privacy' | 'legal' | 'terms'

export function getLegalContent(type: LegalContentType): { title: string; content: ReactNode } {
  switch (type) {
    case 'privacy':
      return {
          ...
          <div className="space-y-6">
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                <a href="/politique-de-confidentialite" className="text-blue-600 hover:underline">www.cash360.finance/politique-de-confidentialite</a>
              </p>
            </div>
        ...
        content: (
          <div className="space-y-6">
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <p className="text-gray-700 leading-relaxed">
                La politique de confidentialité complète est consultable à l'adresse : <a href="/politique-de-confidentialite" className="text-blue-600 hover:underline">www.cash360.finance/politique-de-confidentialite</a>.
              </p>
            </div>
